...
final class Multiplicar{
    ...
    // Criando os atributos direto na classe para nosso objeto Multiplicar, e serão usadas pelo mesmo.
    ...
    public function setNumero1(float $numero1):void
    {
    ...
    public function setNumero2(float $numero2):void
    {
    ...
    public function calcularMultiplicar():float
    {
